...
$lang['CronTasks.crontask.name.delete_expired_password_reset_tokens'] = 'Delete Expired Password Reset Tokens';
$lang['CronTasks.crontask.description.delete_expired_password_reset_tokens'] = 'Removes all the password reset tokens past the expiration date from the system.';

$lang['CronTasks.crontask.name.low_balance_notifications'] = 'Low Balance Notifications';
$lang['CronTasks.crontask.description.low_balance_notifications'] = 'Sends a notice to all users who\'s credit levels have fallen below their configured threshold.';
