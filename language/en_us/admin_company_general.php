...
$lang['AdminCompanyGeneral.!success.language_installed'] = 'The language %1$s has been successfully installed. Remember to update emails, packages, and package groups with content for the new language.'; // %1$s is the name of the language
