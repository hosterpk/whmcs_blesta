...
$lang['AdminCompanyBilling.!success.credithandling_updated'] = 'The Credit Handling settings were successfully updated!';
...
$lang['AdminCompanyBilling.!error.min_amount'] = 'The minimum amount for %1$s must be greater than 0.'; // %1$s is the currency code
$lang['AdminCompanyBilling.!error.max_amount'] = 'The maximum amount for %1$s must be greater than 0.'; // %1$s is the currency code
$lang['AdminCompanyBilling.!error.max_less_than_min'] = 'The maximum amount for %1$s must be greater than the minimum amount.'; // %1$s is the currency code
$lang['AdminCompanyBilling.!error.postalmethods_return_name.empty'] = 'Please enter a return address name.';
$lang['AdminCompanyBilling.!error.postalmethods_return_company.empty'] = 'Please enter a return address company.';
$lang['AdminCompanyBilling.!error.postalmethods_return_address1.empty'] = 'Please enter a return address.';
$lang['AdminCompanyBilling.!error.postalmethods_return_city.empty'] = 'Please enter a return address city.';
$lang['AdminCompanyBilling.!error.postalmethods_return_state.empty'] = 'Please select a return address state/province.';
$lang['AdminCompanyBilling.!error.postalmethods_return_zip.empty'] = 'Please enter a return address zip/postal code.';
$lang['AdminCompanyBilling.!error.postalmethods_return_country.empty'] = 'Please select a return address country.';
...
$lang['AdminCompanyBilling.!tooltip.service_attempts'] = 'The number of attempts and failures to process for a service action before that services action is disabled from automatic completion.';
$lang['AdminCompanyBilling.!tooltip.first_attempt_threshold'] = 'The number of service actions to attempt before delaying the next attempt by the amount specified by the first attempt spacing setting';
$lang['AdminCompanyBilling.!tooltip.second_attempt_threshold'] = 'The number of service actions to attempt before delaying the next attempt by the amount specified by the second attempt spacing setting';
...
$lang['AdminCompanyBilling.!tooltip.quotation_format'] = 'Available tags include: {num} - the quotation number (required); {year} - the four-digit year; {month} - the two-digit month; {day} - the two-digit day of the month.';
$lang['AdminCompanyBilling.!tooltip.quotation_start'] = 'Quotation numbers will begin (and increment) from this starting value.';
$lang['AdminCompanyBilling.!tooltip.quotation_increment'] = 'Subsequent quotation numbers will increment by this value.';
...
$lang['AdminCompanyBilling.!tooltip.payment_credit_enabled'] = 'Check to allow clients to pay credit to their account.';
$lang['AdminCompanyBilling.!tooltip.min_amount'] = 'The minimum amount a client can pay for credit in this currency. Leave blank for no minimum.';
$lang['AdminCompanyBilling.!tooltip.max_amount'] = 'The maximum amount a client can pay for credit in this currency. The effective maximum is the lesser of this value or the maximum minus existing credits. Leave blank for no maximum.';
$lang['AdminCompanyBilling.!tooltip.notification_threshold'] = 'Client will receive a daily notification when their credit balance falls below this amount. Leave blank to disable notifications for this currency.';
...
$lang['AdminCompanyBilling.invoices.field.service_provisioning_attempts'] = 'Service Provisioning Attempts';
$lang['AdminCompanyBilling.invoices.field.service_actions'] = 'Service Actions';
$lang['AdminCompanyBilling.invoices.field.type'] = 'Type';
$lang['AdminCompanyBilling.invoices.field.attempts'] = 'Attempts';
$lang['AdminCompanyBilling.invoices.field.first_attempt_threshold'] = '1st Attempt Spacing Threshold';
$lang['AdminCompanyBilling.invoices.field.first_attempt_spacing'] = '1st Attempt Spacing';
$lang['AdminCompanyBilling.invoices.field.second_attempt_threshold'] = '2nd Attempt Spacing Threshold';
$lang['AdminCompanyBilling.invoices.field.second_attempt_spacing'] = '2nd Attempt Spacing';
...
$lang['AdminCompanyBilling.invoices.field.clients_cancel_options'] = 'Client Cancel Options';
...
$lang['AdminCompanyBilling.invoices.field.requeue_invoice_delivery_on_closed'] = 'Requeue invoices for delivery after they are closed';
...
$lang['AdminCompanyBilling.invoices.text_none'] = 'None';
...
$lang['AdminCompanyBilling.invoices.text_hour'] = '%1$s Hour'; // %1$s is the number 1
$lang['AdminCompanyBilling.invoices.text_hours'] = '%1$s Hours'; // %1$s is a number of hours that is not 1
...
$lang['AdminCompanyBilling.addcoupon.heading_limitations'] = 'Limitations & Restrictions';

$lang['AdminCompanyBilling.addcoupon.heading_usage'] = 'Usage Limitations';
...
$lang['AdminCompanyBilling.addcoupon.option_add'] = 'Add';
$lang['AdminCompanyBilling.addcoupon.option_remove'] = 'Remove';

$lang['AdminCompanyBilling.addcoupon.heading_configurable_options'] = 'Configurable Option Limitations';
$lang['AdminCompanyBilling.addcoupon.description_configurable_options'] = 'This coupon can only be applied if the selected configurable options match. Leave blank to ignore configurable option limitations.';
$lang['AdminCompanyBilling.addcoupon.field_option_group'] = 'Option Group';
$lang['AdminCompanyBilling.addcoupon.field_option'] = 'Option';
$lang['AdminCompanyBilling.addcoupon.field_option_values'] = 'Requirements';
$lang['AdminCompanyBilling.addcoupon.field_min_quantity'] = 'Minimum Quantity';
$lang['AdminCompanyBilling.addcoupon.field_regex_pattern'] = 'Regex Pattern';
$lang['AdminCompanyBilling.addcoupon.text_select_option_group'] = 'Select Option Group';
$lang['AdminCompanyBilling.addcoupon.text_select_option'] = 'Select Option';
$lang['AdminCompanyBilling.addcoupon.text_any_value'] = 'Any Non-Empty Value';
$lang['AdminCompanyBilling.addcoupon.tooltip_regex_pattern'] = 'Enter a regular expression to validate text input (leave blank to require any non-empty value)';

$lang['AdminCompanyBilling.addcoupon.heading_packages'] = 'Package Limitations';
...
$lang['AdminCompanyBilling.editcoupon.heading_limitations'] = 'Limitations & Restrictions';

$lang['AdminCompanyBilling.editcoupon.heading_usage'] = 'Usage Limitations';
...
$lang['AdminCompanyBilling.editcoupon.heading_terms'] = 'Term Limitations';
...
$lang['AdminCompanyBilling.editcoupon.heading_package_options'] = 'Configurable Option Limitations';
$lang['AdminCompanyBilling.editcoupon.description_package_options'] = 'This coupon can only be applied if the selected configurable options match. Leave blank to ignore configurable option limitations.';
$lang['AdminCompanyBilling.editcoupon.field_option_group'] = 'Option Group';
$lang['AdminCompanyBilling.editcoupon.field_option'] = 'Option';
$lang['AdminCompanyBilling.editcoupon.field_option_values'] = 'Requirements';
$lang['AdminCompanyBilling.editcoupon.field_min_quantity'] = 'Minimum Quantity';
$lang['AdminCompanyBilling.editcoupon.field_regex_pattern'] = 'Regex Pattern';
$lang['AdminCompanyBilling.editcoupon.text_select_option_group'] = 'Select Option Group';
$lang['AdminCompanyBilling.editcoupon.text_select_option'] = 'Select Option';
$lang['AdminCompanyBilling.editcoupon.text_any_value'] = 'Any Non-Empty Value';
$lang['AdminCompanyBilling.editcoupon.tooltip_regex_pattern'] = 'Enter a regular expression to validate text input (leave blank to require any non-empty value)';
...
$lang['AdminCompanyBilling.deliverymethods.field_postalmethods_replyenvelope'] = 'Reply Envelope';
$lang['AdminCompanyBilling.deliverymethods.heading_postalmethods_return'] = 'Return Address';
$lang['AdminCompanyBilling.deliverymethods.field_postalmethods_return_name'] = 'Name';
$lang['AdminCompanyBilling.deliverymethods.field_postalmethods_return_company'] = 'Company';
$lang['AdminCompanyBilling.deliverymethods.field_postalmethods_return_address1'] = 'Address 1';
$lang['AdminCompanyBilling.deliverymethods.field_postalmethods_return_address2'] = 'Address 2';
$lang['AdminCompanyBilling.deliverymethods.field_postalmethods_return_city'] = 'City';
$lang['AdminCompanyBilling.deliverymethods.field_postalmethods_return_state'] = 'State/Province';
$lang['AdminCompanyBilling.deliverymethods.field_postalmethods_return_zip'] = 'Zip/Postal Code';
$lang['AdminCompanyBilling.deliverymethods.field_postalmethods_return_country'] = 'Country';
...
// Credit Handling
$lang['AdminCompanyBilling.credithandling.page_title'] = 'Settings > Company > Billing/Payment > Credit Handling';
$lang['AdminCompanyBilling.credithandling.boxtitle_credithandling'] = 'Credit Handling';
$lang['AdminCompanyBilling.credithandling.text_description'] = 'Disabling payments for credits would hide the credit amount field in the client view when making a payment.';
$lang['AdminCompanyBilling.credithandling.heading_limits'] = 'Credit Limits per Currency';
$lang['AdminCompanyBilling.credithandling.field.payment_credit_enabled'] = 'Allow Client Payment for Credit';
$lang['AdminCompanyBilling.credithandling.field.currency'] = 'Currency';
$lang['AdminCompanyBilling.credithandling.field.min_amount'] = 'Minimum Amount';
$lang['AdminCompanyBilling.credithandling.field.max_amount'] = 'Maximum Amount';
$lang['AdminCompanyBilling.credithandling.field.notification_threshold'] = 'Low Balance Threshold';
$lang['AdminCompanyBilling.credithandling.field.submit'] = 'Update Settings';
