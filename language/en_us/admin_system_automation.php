...
$lang['AdminSystemAutomation.index.field_example_command'] = 'Example Cron Command for HTTP Requests';
...
$lang['AdminSystemAutomation.index.text_alternative_method'] = 'Alternative Method (HTTP Request with Cron Key)';
