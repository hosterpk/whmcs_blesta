<?php
/**
 * Language definitions for the Service Changes model
 *
 * @package blesta
...
$lang['ServiceChanges.!error.id.exists'] = 'Invalid service change ID.';
$lang['ServiceChanges.!error.service_id.exists'] = 'Invalid service ID.';
...
$lang['ServiceChanges.status.canceled'] = 'Canceled';
