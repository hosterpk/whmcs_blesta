...
class KuickPayResponseParserTest extends TestCase
{
    ...
    public function inquiryMappingProvider(): array
    {
        ...
        return [
            ...
            'amount overpayment' => [
                '00,REG-0000001,20260609,1100.00,KP-TXN-0001,KP-REF-PAID,PKR,INSTITUTION_ID',
                $context,
                'manual_review',
                'amount_mismatch',
                ['overpayment'],
    ...
    public function inquiryFixtureProvider(): array
    {
        return [
            ...
            ['ambiguous/bill-payment-inquiry-amount-mismatch.xml', 'manual_review', 'amount_mismatch', ['underpayment']],
