 ...
 *
 * @package blesta
 * @subpackage components.quotationdelivery
...
class QuotationDelivery extends InvoiceDelivery
{
    ...
    {
        Loader::loadModels($this, ['Quotations', 'Staff']);
    ...
    public function deliverQuotations(
        ...
        if (!in_array($delivery_method, $non_messenger_methods)) {
            ...
            if (!is_null($from_staff_id)) {
                $tags['staff'] = $this->Staff->get($from_staff_id, $this->company->id);
            }
        ...
        switch ($delivery_method) {
            ...
            case 'postalmethods':
                ...
                foreach ($quotations as $quotation_set) {
                    ...
                    // Fetch all PostalMethods settings in one query
