...
class DirectAdminApi
{
     ...
     * @var string
     */
    public $http_version = CURL_HTTP_VERSION_1_1;
    ...
    public $calls = [
        ...
        'createLoginUrl' => ['GET', 'text', 'CMD_API_LOGIN_KEYS', ['action' => 'create', 'type' => 'one_time_url', 'login_keys_notify_on_creation' => 0]],
     ...
     * @return bool|string
     */
    public function contactApi($call, $method = 'POST', $postvars = [])
    {
        ...
        curl_setopt($ch, CURLOPT_HTTP_VERSION, $this->http_version);
     ...
     *
     * @param mixed $http_version The HTTP version
     */
