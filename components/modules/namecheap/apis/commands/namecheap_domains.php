...
class NamecheapDomains
{
     ...
     *
     * @param array $vars An array of input params including:
     *  - DomainName Domain name for which domain information needs to be requested
     * @return NamecheapResponse
     */
     ...
     *      .CA domain
     *          - CIRALegalType CCO, CCT, RES, GOV, EDU, ASS, HOP, PRT, TDM, TRD,
     *              PLT, LAM, TRS, ABO, INB, LGR, OMK, MAJ
     *          - CIRAWhoisDisplay Full, Private Does the registrant want their contact
     *              information to be published in CIRA’s public Whois? Individuals
     *              (CCT, RES, ABO, LGR) may keep their Registrant contact information private
     *              in CIRA’s Whois; non-individuals must show their full Registrant information.
     *          - CIRAAgreementVersion 2.0 Version of the CIRA Registrant Agreement to which Registrant is agreeing.
     *          - CIRAAgreementValue Y This value should be Y (agreed to agreement) for the
     *              domain to be registered. Passing other values will fail the registration
     *          - CIRALanguage en, fr Language in which to communicate with he contact. Default is en
     *      .CO.UK domain
     *          - COUKLegalType IND, FIND, LTD , PLC, PTNR, LLP, IP, STRA,SCH,FOTHER, RCHAR,
     *              GOV, OTHER, CRC, FCORP, STAT, FOTHER
     *          - COUKCompanyID Company Identification Number
     *          - COUKRegisteredfor Company or Person the domain is registered for
     *      .ME.UK domain
     *          - MEUKLegalType IND, FIND, LTD , PLC, PTNR, LLP, IP, STRA,SCH,FOTHER, RCHAR,
     *              GOV, OTHER, CRC, FCORP, STAT, FOTHER
     *          - MEUKCompanyID Company Identification Number
     *          - MEUKRegisteredfor Company or Person the domain is registered for
     *      .ORG.UK domain
     *          - ORGUKLegalType IND, FIND, LTD , PLC, PTNR, LLP, IP, STRA,SCH,FOTHER, RCHAR,
     *              GOV, OTHER, CRC, FCORP, STAT, FOTHER
     *          - ORGUKCompanyID Company Identification Number
     *          - ORGUKRegisteredfor Company or Person the domain is registered for
     *      .ASIA domain
     *          - ASIACCLocality af, bd, ck, in, jp, kg, mh, nz, ps, sg, th, tv, aq, bt, cy,
     *              id, kz, la, fm, nu, pg, sb, tl, ae, am, bn, fj, ir, ki, lb, mn, nf, ph,
     *              lk, tk, uz, au, kh, ge, iq, kp, mo, mm, om, qa, sy, to, vu, az, cn, hm,
     *              il, kr, my, nr, pk, ws, tw, tr, vn, bh, cc, hk, jo, kw, mv, np, pw, sa, tj, tm, ye
     *          - ASIALocalityCity City of Establishment of the Entity
     *          - ASIALocalitySP State/Province of Establishment of the Entity
     *          - ASIALegalEntityType corporation, cooperative, partnership, government,
     *              politicalParty, society, institution, naturalPerson, other
     ...
     *          - ASIAOtherleType Other Entity Type. Other Entry Type requires if you chose
     *              possible value Other in ASIALegalEntityType Extended attribute
     *          - ASIAOtherIdentForm Other Identification Form. Other Identification Form required
     *              if you chose possible value Other in ASIAIdentForm Extended attribute
     *      .DE domain
     ...
     *          - EUAdrLang BG,CS,DS,NL,EN,ET,FI,FR,DE,,HU, IT,LV,LI,MT,PL,RO,SK,SL,ES,SV
     *      .CA domain
     *          - CIRALegalType CCO, CCT, RES, GOV, EDU, ASS, HOP, PRT, TDM, TRD, PLT, LAM,
     *              TRS, ABO, INB, LGR, OMK, MAJ
     *          - CIRAWhoisDisplay Full, Private Does the registrant want their contact information
     *              to be published in CIRA’s public Whois? Individuals (CCT, RES, ABO, LGR) may keep
     *              their Registrant contact information private in CIRA’s Whois; non-individuals must
     *              show their full Registrant information.
     *          - CIRAAgreementVersion 2.0 Version of the CIRA Registrant Agreement to which Registrant is agreeing.
     *          - CIRAAgreementValue Y This value should be Y (agreed to agreement) for the domain
     *              to be registered. Passing other values will fail the registration
     *          - CIRALanguage en, fr Language in which to communicate with he contact. Default is en
     *      .CO.UK domain
     *          - COUKLegalType IND, FIND, LTD , PLC, PTNR, LLP, IP, STRA,SCH,FOTHER, RCHAR, GOV,
     *              OTHER, CRC, FCORP, STAT, FOTHER
     *          - COUKCompanyID Company Identification Number
     *          - COUKRegisteredfor Company or Person the domain is registered for
     *      .ME.UK domain
     *          - MEUKLegalType IND, FIND, LTD , PLC, PTNR, LLP, IP, STRA,SCH,FOTHER, RCHAR, GOV,
     *              OTHER, CRC, FCORP, STAT, FOTHER
     *          - MEUKCompanyID Company Identification Number
     *          - MEUKRegisteredfor Company or Person the domain is registered for
     *      .ORG.UK domain
     *          - ORGUKLegalType IND, FIND, LTD , PLC, PTNR, LLP, IP, STRA,SCH,FOTHER, RCHAR, GOV,
     *              OTHER, CRC, FCORP, STAT, FOTHER
     *          - ORGUKCompanyID Company Identification Number
     *          - ORGUKRegisteredfor Company or Person the domain is registered for
     *      .ASIA domain
     *          - ASIACCLocality af, bd, ck, in, jp, kg, mh, nz, ps, sg, th, tv, aq, bt, cy, id, kz,
     *              la, fm, nu, pg, sb, tl, ae, am, bn, fj, ir, ki, lb, mn, nf, ph, lk, tk, uz, au, kh,
     *              ge, iq, kp, mo, mm, om, qa, sy, to, vu, az, cn, hm, il, kr, my, nr, pk, ws, tw, tr,
     *              vn, bh, cc, hk, jo, kw, mv, np, pw, sa, tj, tm, ye
     *          - ASIALocalityCity City of Establishment of the Entity
     *          - ASIALocalitySP State/Province of Establishment of the Entity
     *          - ASIALegalEntityType corporation, cooperative, partnership, government, politicalParty,
     *              society, institution, naturalPerson, other
     *          - ASIAIdentForm certificate,legislation, societyRegistry, politicalPartyRegistry, passport, other
     *          - ASIAIdentNumber Form of Identity ID Number/Code of Reference
     *          - ASIAOtherleType Other Entity Type. Other Entry Type requires if you chose possible
     *              value Other in ASIALegalEntityType Extended attribute
     *          - ASIAOtherIdentForm Other Identification Form. Other Identification Form required
     *              if you chose possible value Other in ASIAIdentForm Extended attribute
     *      .DE domain
     *          - DEConfirmAddress DE To confirm the Administrative address is a valid German address
