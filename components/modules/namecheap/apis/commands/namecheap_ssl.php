...
class NamecheapSsl
{
     ...
     *  - WebServerType Possible values: apacheopenssl, apachessl, apacheraven, apachessleay,
     *      c2net, ibmhttp, iplanet, domino, dominogo4625, dominogo4626, netscape, zeusv3, apache2,
     *      apacheapachessl, cobaltseries, cpanel, ensim, hsphere,ipswitch, plesk, tomcat, weblogic,
     ...
     *          - OrganizationRepLegalName Representative's Legal Name. This parameter is required
     *              only if OrganizationRepCallbackDestinationSame parameter is set as No
     *          - OrganizationRepDUNS
     *          - OrganizationRepAddress1 Representative's Address. This parameter is required only
     *              if OrganizationRepCallbackDestinationSame parameter is set as No
     *          - OrganizationRepAddress2 Representative's Address
     *          - OrganizationRepCity Representative's City. This parameter is required only if
     *              OrganizationRepCallbackDestinationSame parameter is set as No
     *          - OrganizationRepStateProvince Representative's State/Province. This parameter is
     *              required if OrganizationRepCallbackDestinationSame parameter is set as No
     *          - OrganizationRepPostalCode Representative's postal code. This parameter is
     *              required only if OrganizationRepCallbackDestinationSame parameter is set as No
     *          - OrganizationRepCountry Representative's country. This parameter is
     *              required only if OrganizationRepCallbackDestinationSame parameter is set as No
     ...
     *      InstantSSL, PositiveSSL, PositiveSSL Wildcard, True BusinessID with EV, True BusinessID ,
     *      True BusinessID Wildcard , Secure Site , Secure Site Pro , Secure Site with EV ,
     *      Secure Site Pro with EV, EssentialSSL, EssentialSSL Wildcard, InstantSSL Pro,
     *      Premiumssl wildcard, EV SSL, EV SSL SGC, SSL123, SSL Web Server, SGC Super Certs, SSL Webserver EV)
     * @return NamecheapResponse
     */
