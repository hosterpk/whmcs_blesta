...
class DefaultInvoicePdf extends TcpdfWrapper
{
    ...
    private function drawAddress()
    {
        ...
        if (strlen($this->invoice->billing->address1) > 0) {
        ...
        $address .= $this->invoice->billing->city
            . ', '
            . ($this->invoice->billing->state_name ?? $this->invoice->billing->state)
            . ' '
            . $this->invoice->billing->zip
            . ' '
            . (($this->invoice->billing->country->format ?? '') == 'name' ? $this->invoice->billing->country->name : $this->invoice->billing->country->alpha3);
