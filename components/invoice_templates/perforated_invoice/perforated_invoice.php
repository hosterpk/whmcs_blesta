...
// Use the Perforated Invoice PDF renderer for generating PDFs
Loader::load(dirname(__FILE__) . DS . 'perforated_invoice_pdf.php');

/**
 * Perforated Invoice Template
 *
 * @package blesta
 * @subpackage components.invoicetemplates.perforated_invoice
 * @copyright Copyright (c) 2015, Phillips Data, Inc.
 * @license http://www.blesta.com/license/ The Blesta License Agreement
 * @link http://www.blesta.com/ Blesta
 */
class PerforatedInvoice extends InvoiceTemplate
{
    /**
    ...
    /**
     * @var PerforatedInvoicePdf The PDF object used for rendering
     */
    private $pdf;
    ...
    /**
     * @var array Invoice data for the last invoice set
     */
    private $invoice = [];
    ...
    public function __construct()
    {
        ...
        Language::loadLang('perforated_invoice', null, dirname(__FILE__) . DS . 'language' . DS);
    }
    ...
    public function setMeta($meta)
    {
        ...
        if (isset($meta['language'])) {
            Language::loadLang('perforated_invoice', $meta['language'], dirname(__FILE__) . DS . 'language' . DS);
        ...
        $this->pdf = new PerforatedInvoicePdf('P', 'px', $this->meta['paper_size'], true, 'UTF-8', false, $font);
     ...
     *
     * @param bool $include_address True to include the address on the PDF, or false otherwise (optional, default true)
     */
    ...
    {
        return Language::_('PerforatedInvoice.name', true);
    }
