 ...
 */
class AdminCompanyClientoptions extends AdminController
{
    /**
     * Pre-action
     */
    ...
    public function editCustomField()
    {
        ...
        if (!empty($this->post)) {
            ...
            if (($errors = $this->Clients->errors())) {
                ...
                $this->redirect($this->base_uri . 'settings/company/clientoptions/editcustomfield/' . $field->id . '/');
            }
        }
    ...
    public function requiredFields()
    {
        ...
        if (!empty($this->post)) {
            ...
            foreach ($contact_fields_groups as $group_name) {
                ...
                $this->Companies->setSettings(
                    $this->company_id,
                    [$group_name => base64_encode(json_encode((array) $this->post[$group_name]))],
                    [$group_name]
                );
            }
        ...
        $this->set('required_fields_form', $this->partial('admin_company_require_fields_form', ['vars' => $vars]));
    }
    ...
    public function general()
    {
        ...
        $this->set(
            ...
            $this->partial(
                ...
                [
                    'vars' => $vars,
                    'unique_email_options' => $this->getUniqueEmailOptions(),
                    'password_formats' => $this->getPasswordFormats()
                ]
            )
        );
    }
     ...
     */
    private function getPasswordFormats()
    {
        return [
            'any' => Language::_('AdminCompanyClientoptions.general.field_password_format_any', true),
            'any_no_space' => Language::_('AdminCompanyClientoptions.general.field_password_format_any_no_space', true),
            'alpha_num' => Language::_('AdminCompanyClientoptions.general.field_password_format_alpha_num', true),
            'alpha' => Language::_('AdminCompanyClientoptions.general.field_password_format_alpha', true),
            'num' => Language::_('AdminCompanyClientoptions.general.field_password_format_num', true),
            'custom' => Language::_('AdminCompanyClientoptions.general.field_password_format_custom', true)
        ];
    }
