 ...
 */
class AdminReportsCustomize extends AppController
{
    /**
     * Bootstrap
     */
    public function preAction()
    {
        ...
        Language::loadLang('admin_reports_customize');
    }
    ...
    public function edit()
    {
        ...
        if (!empty($this->post)) {
            ...
            if (($errors = $this->ReportManager->errors())) {
                ...
                $this->redirect($this->base_uri . 'reports_customize/edit/' . $report->id . '/');
            }
        }
