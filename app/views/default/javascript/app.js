...
(function() {
    ...
    const STORAGE_KEY = 'blesta-theme';
    ...
    /**
     * Get the theme to apply (stored > system > default dark)
     */
    ...
    function initCopyButton() {
        ...
        if (!copyBtn || !cliCommand) return;

        copyBtn.addEventListener('click', function() {
            const commandText = cliCommand.textContent.trim();
    ...
    function initTermsToggle() {
        ...
        const installerSections = document.getElementById('installer-sections');

        if (!agreeTermsCheckbox || !installerSections) return;

        agreeTermsCheckbox.addEventListener('change', function() {
            if (this.checked) {
                installerSections.classList.add('enabled');
            } else {
                installerSections.classList.remove('enabled');
            }
        });
    }

    // Initialize terms toggle when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initTermsToggle);
    } else {
        initTermsToggle();
    }
    ...
    function initReloadButton() {
        ...
        reloadBtn.addEventListener('click', function() {
            this.innerHTML = '<span class="spinner-border spinner-border-sm mx-2" role="status" aria-hidden="true"></span>';
            this.disabled = true;
    ...
    // Initialize reload button when DOM is ready
    if (document.readyState === 'loading') {
    ...
    /**
     * Prevents the designated forms from being submitted multiple times
     */
    function initPreventDoubleSubmission() {
        // Find all forms with disable-on-submit class and bind directly to each
        ...
        forms.forEach(function(form) {
            ...
            form.addEventListener('submit', function(e) {
                ...
                // Disable all submit buttons after a tiny delay to allow form submission to start
                var formEl = this;
                setTimeout(function() {
    ...
    // Initialize prevent double submission button when DOM is ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPreventDoubleSubmission);
    } else {
