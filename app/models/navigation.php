        ...
        $nav = [
            ...
            [
                ...
                'children' => [
                    ...
                    [
                        'name' => $this->_('Navigation.getcompany.nav_billing_credithandling'),
                        'uri' => $base_uri . 'settings/company/billing/credithandling/'
                    ],
                    [
            ...
            [
                'name' => $this->_('Navigation.getcompany.nav_electronic_invoices'),
                'class' => '',
                'icon' => 'file-invoice',
                'uri' => $base_uri . 'settings/company/electronic_invoices/'
            ],
            [
            ...
            [
                ...
                'children' => [
                    ...
                    [
                        'name' => $this->_('Navigation.getcompany.nav_html_templates'),
                        'uri' => $base_uri . 'settings/company/emails/htmltemplates/'
                    ],
                    [
