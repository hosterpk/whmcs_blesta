...
Configure::set('broadsat.map', [
    ...
    'module_row_meta' => [
        (object)['key' => 'package_field_label_0', 'value' => 'Login', 'serialized' => 0, 'encrypted' => 0],
        (object)['key' => 'package_field_name_0', 'value' => 'login', 'serialized' => 0, 'encrypted' => 0],
        ...
        (object)['key' => 'package_field_values_0', 'value' => (object)['module' => 'login'], 'serialized' => 0, 'encrypted' => 0],
        ...
        (object)['key' => 'service_field_label_0', 'value' => 'Hardware MAC', 'serialized' => 0, 'encrypted' => 0],
        ...
        (object)['key' => 'service_field_label_1', 'value' => 'User Login', 'serialized' => 0, 'encrypted' => 0],
        ...
        (object)['key' => 'service_field_label_2', 'value' => 'Consumed Traffic', 'serialized' => 0, 'encrypted' => 0],
        (object)['key' => 'service_field_name_2', 'value' => 'opt1', 'serialized' => 0, 'encrypted' => 0],
