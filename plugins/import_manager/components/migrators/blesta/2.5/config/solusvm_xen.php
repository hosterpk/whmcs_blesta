...
Configure::set('solusvm_xen.map', [
    ...
    'package_meta' => [
        ...
        (object)['key' => 'nodes', 'value' => (object)['package' => 'instantact'], 'serialized' => 1, 'encrypted' => 0, 'callback' => 'solusvm_xen_nodes'],
        (object)['key' => 'plan', 'value' => (object)['package' => 'instantact'], 'serialized' => 0, 'encrypted' => 0, 'callback' => 'solusvm_xen_plan'],
