...
Configure::set('virtualmin.map', [
    ...
    'module_row_meta' => [
        ...
        (object)['key' => 'port', 'value' => (object)['module' => 'port'], 'serialized' => 0, 'encrypted' => 1, 'callback' => function ($value) { return empty($value) ? '10000' : $value;}],
        ...
        (object)['key' => 'account_limit', 'value' => (object)['module' => 'maxaccounts'], 'serialized' => 0, 'encrypted' => 0, 'callback' => function ($value) { return empty($value) ? '0' : $value;}]
    ],
    'package_meta' => [
        (object)['key' => 'plan', 'value' => (object)['package' => 'configoption2'], 'serialized' => 0, 'encrypted' => 0, 'callback' => function ($value) { return empty($value) ? '' : $value;}],
        (object)['key' => 'template', 'value' => (object)['package' => 'configoption1'], 'serialized' => 0, 'encrypted' => 0, 'callback' => function ($value) { return empty($value) ? '' : $value;}],
