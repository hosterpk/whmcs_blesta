<?php
/**
 * Language definitions for the Billing Overview plugin Admin Main controller/views
 *
 * @package blesta
 * @subpackage plugins.billingoverview.language.en_us
...
$lang['AdminMain.index.statistic.revenue_today'] = "Revenue Today";
$lang['AdminMain.index.statistic.revenue_month'] = "Revenue this Month";
$lang['AdminMain.index.statistic.revenue_year'] = "Revenue this Year";
$lang['AdminMain.index.statistic.credits_today'] = "Credits Today";
$lang['AdminMain.index.statistic.credits_month'] = "Credits this Month";
...
$lang['AdminMain.index.statistic.invoiced_today_proforma'] = "Invoiced Today (Proforma)";
$lang['AdminMain.index.statistic.invoiced_month_proforma'] = "Invoiced this Month (Proforma)";
$lang['AdminMain.index.statistic.balance_outstanding'] = "Outstanding Balance";
$lang['AdminMain.index.statistic.balance_overdue'] = "Overdue Balance";
$lang['AdminMain.index.statistic.scheduled_cancelation'] = "Scheduled Cancelations";
$lang['AdminMain.index.statistic.services_active'] = "Active Services";
$lang['AdminMain.index.statistic.services_added_today'] = "Services Added Today";
$lang['AdminMain.index.statistic.services_canceled_today'] = "Services Canceled Today";
...
$lang['AdminMain.settings.graph_revenue_year'] = "Revenue Graph (Year to Date)";
$lang['AdminMain.settings.graph_invoiced'] = "Amount Invoiced Graph";

$lang['AdminMain.settings.text_graph_settings'] = "Manage the graph settings for the graphs that will appear on the Billing Overview.";
...
// Graph titles
$lang['AdminMain.graph_name.graph_revenue'] = "Revenue (Range)";
$lang['AdminMain.graph_name.graph_revenue_year'] = "Revenue (Year to Date - %1\$s)";
...
$lang['AdminMain.graph_line_name.credits'] = "Credits";
