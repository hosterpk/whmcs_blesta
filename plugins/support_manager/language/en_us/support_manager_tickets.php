...
$lang['SupportManagerTickets.!error.recipients.duplicated'] = 'At least one of the ticket recipients is duplicated.';
$lang['SupportManagerTickets.!error.recipients.valid'] = 'At least one of the ticket recipients is invalid.';
$lang['SupportManagerTickets.!error.contacts.valid'] = 'At least one of the ticket contacts is invalid.';
$lang['SupportManagerTickets.!error.priority.valid'] = 'Please select a valid priority for this department.';
...
$lang['SupportManagerTickets.!error.custom_fields.empty'] = '"%1$s" is required and can\'t be empty.'; // %1$s is the name of the custom field
...
$lang['SupportManagerTickets.log.service_id'] = 'The related service has been changed to internal ID: #%1$s.'; // %1$s is the status
