...
$lang['AdminDepartments.!success.department_imported'] = 'The %1$s department was successfully imported.'; // %1$s is the name of the department
...
$lang['AdminDepartments.!tooltip.enable_related_services'] = 'Allow clients to select a service to which the ticket is related.';
...
$lang['AdminDepartments.!tooltip.feedback_ticket_interval'] = 'For all tickets with a status of closed, a reminder to leave their feedback will be sent to the client if the ticket has been closed for the selected amount of time.'; // %1$s is the ticket status Closed
...
$lang['AdminDepartments.!tooltip.type'] = '"Escalate to Emergency" shows an alert box with a message and checkbox. If the user checks the checkbox, the ticket is automatically escalated to "Emergency", even if that priority is disabled for the department. Only available when Visibility is set to Client Only.';
...
$lang['AdminDepartments.!text.description_hint'] = 'This description will be visible to clients when selecting a department';
$lang['AdminDepartments.!text.priorities_hint'] = 'Hold Ctrl (Windows) or Cmd (Mac) to select multiple priorities';
$lang['AdminDepartments.!text.search_responses'] = 'Search responses...';
$lang['AdminDepartments.!text.searching'] = 'Searching...';
...
$lang['AdminDepartments.add.field_enable_related_services'] = 'Enable related services';
...
$lang['AdminDepartments.add.field_priorities'] = 'Available Priorities';
...
$lang['AdminDepartments.add.field_oauth2_provider'] = 'OAuth 2.0 Provider';
$lang['AdminDepartments.add.field_oauth2_user'] = 'OAuth 2.0 User';
$lang['AdminDepartments.add.field_oauth2_client_id'] = 'OAuth 2.0 Client / Application ID';
$lang['AdminDepartments.add.field_oauth2_client_secret'] = 'OAuth 2.0 Client / Application Secret';
...
$lang['AdminDepartments.add.field_feedback_ticket_interval'] = 'Automatically Send Feedback Reminder';
...
$lang['AdminDepartments.add.heading_required'] = 'Required';
...
$lang['AdminDepartments.add.confirm_field_remove'] = 'Are you sure you want to remove this custom field?';
$lang['AdminDepartments.add.text_emergency_field'] = 'Only one field can be set to emergency at a time.';
...
$lang['AdminDepartments.edit.field_enable_related_services'] = 'Enable related services';
...
$lang['AdminDepartments.edit.field_priorities'] = 'Available Priorities';
...
$lang['AdminDepartments.edit.field_oauth2_provider'] = 'OAuth 2.0 Provider';
$lang['AdminDepartments.edit.field_oauth2_user'] = 'OAuth 2.0 User';
$lang['AdminDepartments.edit.field_oauth2_client_id'] = 'OAuth 2.0 Client / Application ID';
$lang['AdminDepartments.edit.field_oauth2_client_secret'] = 'OAuth 2.0 Client / Application Secret';
...
$lang['AdminDepartments.edit.field_feedback_ticket_interval'] = 'Automatically Send Feedback Reminder';
...
$lang['AdminDepartments.edit.heading_required'] = 'Required';
...
$lang['AdminDepartments.edit.text_emergency_field'] = 'Only one field can be set to emergency at a time.';
