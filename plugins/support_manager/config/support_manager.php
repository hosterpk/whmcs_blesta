...
Configure::set('SupportManager.install.emails', [
    ...
    [
        ...
        'type' => 'client',
        'plugin_dir' => 'support_manager',
        'tags' => '{ticket},{update_ticket_url},{ticket_hash_code},{client},{subject},{staff_name}',
        'from' => 'support@mydomain.com',
        'from_name' => 'Support',
...
'
    ...
    [
        'action' => 'SupportManager.ticket_feedback',
        'type' => 'client',
        'plugin_dir' => 'support_manager',
        'tags' => '{ticket},{client},{feedback_ticket_url}',
        'from' => 'support@mydomain.com',
        'from_name' => 'Support',
        'subject' => 'Give us your feedback about your recent ticket',
        'text' => 'We recently helped you via our {ticket.department_name} department regarding: {ticket.summary}

Please rate your experience: https://{feedback_ticket_url}

Your feedback helps us improve future support. Thank you!',
        'html' => '<p>We recently helped you via our {ticket.department_name} department regarding: {ticket.summary}</p>

<p>Please rate your experience: <a href="https://{feedback_ticket_url}">{feedback_ticket_url}</a></p>

<p>Your feedback helps us improve future support. Thank you!</p>'
    ]
]);
