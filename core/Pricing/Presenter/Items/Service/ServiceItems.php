...
class ServiceItems extends AbstractServiceItems
{
    ...
    public function build(
        ...
        // Set service options for coupon validation and apply discounts to the items
    ...
    private function makeOptionItems(ItemCollection $options, ItemInterface $package)
    {
        ...
        foreach ($options as $option) {
            ...
            // Skip options with disabled pricing
            if (isset($optionFields->hide_on_invoice) && $optionFields->hide_on_invoice == 1) {
                continue;
            }
