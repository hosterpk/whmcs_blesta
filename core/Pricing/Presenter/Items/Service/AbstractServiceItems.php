 ...
 *
 * @package blesta
 * @subpackage core.Pricing.Presenter.Items.Service
...
abstract class AbstractServiceItems implements ServiceItemsInterface
{
    ...
    protected $taxes;
    /**
     * @var ItemCollection Current service options for coupon validation
     */
    ...
    private function getDiscounts(array $packageIds)
    {
        ...
        foreach ($this->discounts as $discount) {
            ...
            // Add current service options to discount fields for coupon validation
            if (isset($this->serviceOptions) && $this->serviceOptions) {
                $discountFields->service_options = $this->serviceOptions;
            }
            // Add current package options to discount fields for coupon validation
            if (isset($this->packageOptions) && $this->packageOptions) {
                $discountFields->package_options = $this->packageOptions;
            }
     ...
     *
     * @param array $options A collection of service options
     */
    protected function setServiceOptions($options)
    {
     ...
     *
     * @param ItemCollection $options A collection of service options
     */
