...
/**
 * The Client Notes event handler
 *
 * @package blesta
 ...
 */
class ClientNotes extends Handler
{
    // Include traits
    use Container;
    ...
    private function clientsDelete($client_id)
    {
        ...
        while ($this->Clients->getNoteListCount($client_id) > 0) {
            $notes = $this->Clients->getNoteList($client_id);
