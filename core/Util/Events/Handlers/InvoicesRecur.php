...
use Blesta\Core\Util\Events\Handler;

/**
 * The Recurring Invoices event handler
 *
 * @package blesta
 * @subpackage core.Util.Events.Handlers
 * @copyright Copyright (c) 2019, Phillips Data, Inc.
 * @license http://www.blesta.com/license/ The Blesta License Agreement
 * @link http://www.blesta.com/ Blesta
 */
class InvoicesRecur extends Handler
{
    // Include traits
    use Container;
    ...
    private function clientsDelete($client_id)
    {
        ...
        // Delete all recurring invoices for this client
        $this->Invoices->deleteRecurringByClient($client_id);
    }
}
