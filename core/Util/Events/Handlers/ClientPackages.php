...
/**
 * The Client Packages event handler
 *
 * @package blesta
 ...
 */
class ClientPackages extends Handler
{
    // Include traits
    use Container;
    ...
    private function clientsDelete($client_id)
    {
        ...
        // Delete the client's restricted packages
        $this->Clients->deleteRestrictedPackages($client_id);
    }
}
