 ...
 *
 * @package blesta
 * @subpackage helpers.currencyformat
 * @copyright Copyright (c) 2010, Phillips Data, Inc.
 * @license http://www.blesta.com/license/ The Blesta License Agreement
 * @link http://www.blesta.com/ Blesta
 */
class CurrencyFormat extends Helper
{
    /**
     ...
     *      defined precision)
     *  - significant_decimals True to include only the significant decimals (non-zero), regardless of the
     *      given decimals precision (optional, false by default)
